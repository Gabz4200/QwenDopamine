...
"""Family-specific heads re-export shim.

Each head class now lives in its own module for single-responsibility
compliance. This shim preserves the original ``qwendopamine.models.shared.heads``
import path.
"""
